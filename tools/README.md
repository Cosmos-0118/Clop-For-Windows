...
For pinned vendor releases, prefer immutable archive URLs over moving `stable`, `latest`, or redirect-based endpoints. That keeps historical CI runs reproducible after upstream promotes a newer point release.
