...
- [ ] **P2.3 – Video pipeline**: Mirror `Video.swift` features: ffmpeg progress scraping, FPS caps, Media Engine hardware acceleration (map to Windows Video Acceleration), GIF export via `gifski`. Provide regression tests using sample MOV/MP4 assets.
